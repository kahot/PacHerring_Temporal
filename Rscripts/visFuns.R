plotCorRes <- function(cor_mat, pop=NULL, ord=NULL, superpop=NULL,
                       ...
                       cex.main=1, cex.lab=0.9, cex.legend=1, color_palette=c("#001260", "#EAEDE9", "#601200"),
                       pop_labels = c(T,T), plot_legend = T, adjlab = 0.1, rotatelabpop=90, rotatelabsuperpop=0,lineswidth=1, lineswidthsuperpop=2,
                       adjlabsuperpop=0.16,cex.lab.2 = 0.9){
