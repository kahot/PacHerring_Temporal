...
{png("../Output/LD/PWS_LDdecay_ngsLD_all_d600.png", width=5.5, height=5.5, units="in",res=300)
...
```
![](../Output/LD/PWS_LDdecay_ngsLD_all_d600.png)
...
{png("../Output/LD/TB_LDdecay_ngsLD_all_d600.png", width=5.5, height=5.5, units="in",res=300)
par(mar = c(5.1, 5.1, 4.1, 2.1)) 
...
```
![](../Output/LD/TB_LDdecay_ngsLD_all_d600.png)
...
{png("../Output/LD/SS_LDdecay_ngsLD_all_d600.png", width=5.5, height=5.5, units="in",res=300)
par(mar = c(5.1, 5.1, 4.1, 2.1)) 
...
```
![](../Output/LD/SS_LDdecay_ngsLD_all_d600.png)
...
{png("../Output/LD/LDdecay_ngsLD_all_d600_3pops.2017.png", width=5.5, height=5.5, units="in",res=300)
par(mar = c(5.1, 5.1, 4.1, 2.1)) 
...
{png("../Output/LD/LDdecay_ngsLD_all_d600_3pops.2006.png", width=5.5, height=5.5, units="in",res=300)
par(mar = c(5.1, 5.1, 4.1, 2.1)) 
...
{png("../Output/LD/LDdecay_ngsLD_all_d600_3pops.1996.png", width=5.5, height=5.5, units="in",res=300)
par(mar = c(5.1, 5.1, 4.1, 2.1)) 
...
```
![](../Output/LD/LDdecay_ngsLD_all_d600_3pops.2017.png)
![](../Output/LD/LDdecay_ngsLD_all_d600_3pops.2006.png)

![](../Output/LD/LDdecay_ngsLD_all_d600_3pops.1996.png)
